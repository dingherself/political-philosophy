...
- For simplicity, we will consider *only* the distribution of wealth and income; if it helps, let it be knowledge that we have agreed in a previous original position to a scheme of equal basic liberties in the image of Rawls’ first principle.
- Known to us:
...
- *NYC exceptionalism*: Wealth and income are to be distributed in a way that is to the greatest benefit of New Yorkers.
