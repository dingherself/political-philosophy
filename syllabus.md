...
<div class="row no-gutters gx-0 mb-0">
      ...
      <script language="JavaScript" type="text/javascript">
            ...
            var o = "barnard";
            var c = ".";
            var aaa = "{{ site.ta2_netid }}";
            var t = " ";
            var s = "@";
            document.write("<p><strong>{{ site.ta2_title }}</strong>: {{ site.ta2_name | smartify }}<br /><strong>Email</strong>:" + t + "<a href='" + "mail" + "to:" + aaa + s + o + c + g + "'>" + aaa + s + o + c + g + "</a><br />" + "</p>");
      </script>
      <noscript><p><strong>{{ site.ta2_title }}</strong>: {{ site.ta2_name | smartify }}<br /><strong>Email</strong>:[you must enable JavaScript in your web browser to view the email address]<br /></p></noscript>
      </div>
</div>
...
I have asked [Book Culture](https://www.bookculture.com) to order the following text; you can usually find excellent bargains from used bookstores too (e.g., try searching on [BookFinder](https://bookfinder.com)). [Bookshop](https://bookshop.org) is another place to shop independent bookstores.

- Andrew Bailey, Samantha Brennan, Will Kymlicka, Jacob T. Levy, Alex Sager, and Clark Wolf, eds., <em>The Broadview Anthology of Social and Political Thought: From Machiavelli to Nietzsche</em> (2018). Paperback, 978-1554814220, $58.95.

<div class="alert alert-light" role="alert">
  <span style="font-size: 0.93rem;">NB: If you can find a used copy, <em>The Broadview Anthology of Social and Political Thought: Essential Readings</em> (ISBN 978-1554811021) also works. Because the anthologized readings are all in the public domain, finding everything on Project Gutenberg is another option.</span>
</div>
...
- [Four short response papers](#response-papers): 40%
- [Scaffolded term paper](#scaffolded-term-paper): 50%
